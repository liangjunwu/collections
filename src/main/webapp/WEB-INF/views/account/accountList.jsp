...
<script type="text/javascript">
	$(function(){
		...
		$("#add_goods_combobox").combobox({
			valueField:'gid',
			textField:'goods_name',
			url:'${pageContext.servletContext.contextPath}/orders/getAllGoods'
		});
	...
	<div data-options="region:'center',border:false">
		...
		<table id="orders_content_datagrid" class="easyui-datagrid" 
			data-options="border:false, 
						  ...
						  collapsible: true,
						  rownumbers: true,
						  url:'${pageContext.servletContext.contextPath}/account/getAccountData', 
						  pagination:true,
						  toolbar: '#account_datagrid_toolbar',
						">
						
			<thead data-options="frozen:true">
				<tr>
					<th data-options="field:'id'">帐户ID</th>
					<th data-options="field:'account_name'">账户名</th>
					<th data-options="field:'platform'">平台</th>
...
<div id="account_datagrid_toolbar">
...
<jsp:include page="accountAdd.jsp"></jsp:include>
<jsp:include page="accountEdit.jsp"></jsp:include>
